...
const key = "PharmacyAdmin";
const value = "pharmacyadmin";
const MSPID = "PharmacyMSP";
...
exports.PharmaAdminQuery= async(req,res,org,orgId,AdminID) => {
    ...
    if(fun_name == "PharmaAdmin_readPatientPrescription"){
