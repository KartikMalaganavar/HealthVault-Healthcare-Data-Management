...
// the Context class provides contextual information and functionality for a chaincode transaction.
// It is used to interact with the ledger, access the current transaction's metadata, and retrieve any transient data included with the transaction.
// REMEMBER THIS NAME CONTEXT
...
//  The assert function is a part of Sinon.js and is used to make assertions in tests.

chai.use(sinonChai);
// chai >> asertion library
// chai.use(sinonChai), you are telling Chai to include the sinonChai plugin and make its assertion methods available in your tests.
...
describe("Asset Transfer Basic Tests", () => {
  ...
  beforeEach(() => {
    ...
    // This line creates a stub instance of the ChaincodeStub class using the Sinon
    // //  library, which is used to simulate the behavior of the chaincode stub in a test environment.
    ...
    // This line defines a fake implementation for the putState() method of the chaincode stub.
    // The fake implementation stores the key-value pair passed to it in the states object of the chaincode stub instance.
    ...
    // The fake implementation retrieves the value associated with the given key from the states object of the chaincode stub instance
    ...
    // The fake implementation deletes the key-value pair associated with the given key from the states object of the chaincode stub instance
    // and returns the deleted key as a resolved promise.

    chaincodeStub.getStateByRange.callsFake(async () => {
      function* internalGetStateByRange() {
        
        // "internalGetStateByRange"  function returns a Promise that resolves to a generator function "internalGetStateByRange()"
        // .The "internalGetStateByRange()" function is a generator function 
        // that iterates over a shallow copy of the "chaincodeStub.states"
  ...
  // getStateByRange >> function used to retrieve a range of key-value pairs from the ledger based on a given range query.
  ...
  describe("Test CreateAsset", () => {
    it("should return error on CreateAsset", async () => {
      ...
      let assetTransfer = new AssetTransfer();
      try {
        // assetTransfer = new (fabriccontractapi.context)
