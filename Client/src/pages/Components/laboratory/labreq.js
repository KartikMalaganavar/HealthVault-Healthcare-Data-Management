                        ...
                        <ul>
                            <li className="is-active" id="Patient-ID">
                                <a onClick={() => { queryfucntion("Patient-ID") }}>
                                    ...
                                    <span>Patient Laboratory Requisition</span>
                                </a>
                            </li>
                        ...
                        <div className="card-content">
                            <div className="columns is-align-items-flex-end" >
                                <div className="column is-four-fifths">
                                    <label className="label">View lab requisition by {query}</label>
...
export default ViewPatientLabReq;