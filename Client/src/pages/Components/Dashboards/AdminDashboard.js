                        ...
                        <div className="mb-6">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <div className="columns is-half" >
                                        <div className="column">
                                            <Link to="/admin/createDoctor" className="button is-active is-primary is-fullwidth">Create BillManager</Link>
                                        </div>
                                        <div className="column">
                                            <Link to="/admin/viewDoctor" className="button is-active is-primary is-fullwidth">View BillManager</Link>
                                        </div>
                                        <div className="column">
                                            <Link to='/admin/deleteDoctor'>
                                                <button class="button is-active is-fullwidth is-danger is-outlined">Delete BillManager</button>
                                            </Link>
                                        </div>
                                    </div>
                                </div>
