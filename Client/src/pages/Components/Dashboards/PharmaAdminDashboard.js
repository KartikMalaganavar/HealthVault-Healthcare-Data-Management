            ...
            <div class="hero-body">
                <div class="container">
                    <div className="column is-half is-offset-3">
                        <div className='mb-6'>
                            <p className='is-size-2'>Welcome, Pharmacy Admin</p>
                        </div>
                        {/* <div className="mb-6">
                            <div class="card">
                        ...
                        <div className="mb-6">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <div className="columns is-half" >
                                        <div className="column">
                                            <Link to="/pharmaadmin/patient/prescription" className="button is-active is-primary is-fullwidth">View prescription</Link>
